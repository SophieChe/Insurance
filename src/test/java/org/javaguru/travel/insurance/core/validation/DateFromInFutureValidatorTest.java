...
public class DateFromInFutureValidatorTest {
    @Mock
    private ValidationErrorFactory errorFactory;
    @InjectMocks
    private DateFromInFutureValidator validation;
    ...
    public void shouldReturnErrorWhenAgreementDateFromInThePast() {
        when(request.getAgreementDateFrom()).thenReturn(LocalDate.of(2024, 1, 12));
        when(errorFactory.buildError("ERROR_CODE_1")).thenReturn(validationErrorFields);
